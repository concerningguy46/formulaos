...
/**
 * Registration page — email/password signup + Google OAuth.
 */
const RegisterPage = () => {
      ...
      <div className="w-full max-w-[420px] animate-fadeIn">
        <div className="surface-panel p-10">
          <div className="mb-8">
            ...
            <p className="mt-3 text-sm text-ink-3">Start saving formulas in seconds</p>
          </div>
        ...
        <p className="text-center text-ink-3 text-sm mt-6">
          ...
          <Link to="/login" className="text-ink hover:text-ink-2 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
